...
This interactive data report lets you independently explore the findings from Wave 127 of the American Trends Panel. The survey covered the internet, social media, and digital privacy and Black Lives Matter protests, the police, and patriotism.
...
prev_section_i <- "" #Creates object needed for loop logic
...
for (i in items) { # For each survey item, print item details and render results
  ...
  section_i <- unique(metadata$Section[metadata$Item == i])
  
  if (prev_section_i != section_i) {
    if (prev_section_i != ""){cat('<hr style="border: 2px solid #234D37;">\n')}
    cat('## ',section_i,'\n')} # prints new sections
  
  prev_section_i <- section_i
